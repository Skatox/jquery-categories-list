function jquery_categories_list_animate( clickedObj, options ) {
	...
	if (
		jQuery( clickedObj ).siblings( 'ul' ).children( 'li' ).is( ':hidden' )
	) {
		...
		else jQuery( clickedObj ).siblings( 'ul' ).children( 'li' ).show();
	} else if ( options.fx_in === 'fadeIn' )
		jQuery( clickedObj )
			.siblings( 'ul' )
			.children( 'li' )
			.fadeOut( '', changeSymbol );
	else if ( options.fx_in === 'slideDown' )
		jQuery( clickedObj )
			.siblings( 'ul' )
			.children( 'li' )
			.slideUp( '', changeSymbol );
	else
		jQuery( clickedObj )
			.siblings( 'ul' )
			.children( 'li' )
